...
public class UserDto {
    ...
    public UserDto(
            Integer userId,
            @NotBlank(message = "Name is required") @Size(min = 2, max = 60, message = "Name must be between 2 and 60 characters") String name,
            ...
            @NotNull(message = "Role is required") @Pattern(regexp = "Admin|Seller|Buyer", message = "Role must be Admin, Seller, or Buyer") String role,
            Integer locationId
    ) {
        this.userId = userId;
        this.name = name;
